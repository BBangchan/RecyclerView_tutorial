...
class MainActivity : AppCompatActivity(), MyRecyclerviewInterface {
   ...
   override fun onCreate(savedInstanceState: Bundle?) {
       ...
       Log.d(TAG,"MainActivity - 반복문 돌리기 전 this.modelList.size : ${this.modelList.size}")
        ...
        // 10번 반복
        for(i in 1..10){
           var myModel = MyModel(name = "빵대리 $i",profileImage = "https://img1.daumcdn.net/thumb/C100x100.mplusfriend/?fname=http%3A%2F%2Fk.kakaocdn.net%2Fdn%2FIxxPp%2FbtqC9MkM3oH%2FPpvHOkfOiOpKUwvvWcxhJ0%2Fimg_s.jpg\" class=\"img_thumb\" alt=\"\" style=\"width: auto; height: 100%; position: absolute; inset: -100%; margin: auto; min-height: 100%; min-width: 100%;\">" )
